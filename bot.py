...
# ===========================================================
# COMMANDE LEVEL / RANK (GÉNÉRATION D'IMAGE TYPE RANK CARD)
# ===========================================================
...
async def level(ctx, member: discord.Member = None):
    ...
    # Création de la carte image via Pillow
    card = Image.new("RGBA", (900, 300), (32, 34, 37, 255))
    draw = ImageDraw.Draw(card)

    # Fond stylé / blocs internes
    draw.rounded_rectangle([20, 20, 880, 280], radius=20, fill=(47, 49, 54, 255))
    draw.rounded_rectangle([40, 160, 860, 250], radius=10, format=None, fill=(54, 57, 63, 255))
    ...
    # Écriture des textes (fallback police par défaut si police système absente)
    try:
...
async def niveauconfig(ctx):
    await ctx.send("✅ Système de niveaux actif (Génération d'image de profil activée).")

# ===========================================================
# SYSTÈME DE TICKETS PAR BOUTON
# ===========================================================
...
async def giveaway(ctx, duration: int, *, prize: str):
    ...
    # Boucle de mise à jour dynamique du compte à rebours
    remaining = duration
    while remaining > 0:
